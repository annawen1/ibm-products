import{j as i,p as l,B as s}from"./settings-K-okNOOf.js";import{R as p}from"./index-CTjT7uj6.js";import{P as e}from"./index-BRV0Se7Z.js";import{g as d}from"./devtools-Bwmhsu0A.js";import{p as h,a as c}from"./props-helper-BHboZCEP.js";import"./deprecate-BLSDO8J_.js";import{T as m,t as u,p as f,a as y}from"./TearsheetShell-b54oqIwy.js";import{A as b}from"./ActionSet-B0KKiE1i.js";const n="TearsheetNarrow",g={verticalPosition:"lower"};let t=p.forwardRef(({verticalPosition:o=g.verticalPosition,...a},r)=>i.jsx(m,{...d(n),...h(a,y),verticalPosition:o,ref:r,size:"narrow"}));t=l.checkComponentEnabled(t,n);t.displayName=n;const T={verticalPosition:e.oneOf(["normal","lower"])};t.propTypes={actions:c([b.validateActions(()=>"lg"),e.arrayOf(e.shape({...s.propTypes,kind:e.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:e.string,loading:e.bool,onClick:s.propTypes.onClick}))]),ariaLabel:e.string,className:e.string,closeIconDescription:e.string.isRequired.if(({actions:o,hasCloseIcon:a})=>u(o,a)),description:e.node,hasCloseIcon:e.bool,label:e.node,onClose:e.func,open:e.bool,portalTarget:f,title:e.node,...T};t.__docgenInfo={description:`A narrow tearsheet is a slimmer variant of the tearsheet, providing a dialog
