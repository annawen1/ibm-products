import{p as h,a as ie,j as e,B as F}from"./settings-K-okNOOf.js";import{c as q}from"./deprecate-BLSDO8J_.js";import{L as W}from"./Link-B87RWa8F.js";import{g as ce}from"./story-helper-C7EUxzen.js";import{useMDXComponents as G}from"./index-DSkyVWTJ.js";import"./chunk-HLWAVYOI-CelMkzh-.js";import{e as le,i as de,C as he}from"./index-Cf6dYWJP.js";import{r as a,R as me}from"./index-CTjT7uj6.js";import{r as J}from"./index-DN5spsdJ.js";import{P as n}from"./index-BRV0Se7Z.js";import{g as Q}from"./devtools-Bwmhsu0A.js";import{e as ue,b as pe,C as fe,a as ke,c as A,d as m}from"./CoachmarkOverlayElements-DOUEP5Ll.js";import{S as ye}from"./SteppedAnimatedMedia-CpPLcf59.js";import{c as ge}from"./bucket-8-zc1UuW7K.js";import{C as be}from"./CoachmarkTagline-CvSSJnb_.js";import"./index-BU4hwJwl.js";import"./events-D0gen66i.js";import"./tslib.es6-CI8bilKU.js";import"./iframe-ZAk7Pddq.js";import"../sb-preview/runtime.js";import"./react-18-BLKOY-yY.js";import"./extends-CCbyfPlC.js";import"./index-C2eUe6cH.js";import"./inheritsLoose-SLCf_n8R.js";import"./toString-Cu7nsjnZ.js";import"./isSymbol-D87B3_a6.js";import"./index-D4-blIwu.js";import"./index-DrFu-skq.js";import"./uuidv4-BQrI85uz.js";import"./bucket-5--iEWWNCt.js";import"./lodash-BQHnPze3.js";import"./Carousel-CSdbdvcJ.js";import"./lottie-psT8NuZy.js";import"./clamp-r4E2dvSg.js";import"./toNumber-CpuPfuLu.js";const H=`${h.prefix}--coachmark-stacked-home`,f=`${h.prefix}--coachmark-overlay`,L="CoachmarkStackHome";let C=a.forwardRef(({className:o,description:t,isOpen:g,media:u,navLinkLabels:N,onClickNavItem:_,onClose:b,portalTarget:E,closeButtonLabel:O,title:x,...B},P)=>{const w=a.useRef(),[$,s]=a.useState(0);if(a.useEffect(()=>{setTimeout(()=>{g&&w.current&&w.current.focus()},100)},[g]),!N)return ie.warn(`${L} is a Novice to Pro internal component and is not intended for general use.`);const j=E?document.querySelector(E)??document.querySelector("body"):document.querySelector("body");return J.createPortal(e.jsxs("div",{...B,className:q(H,o),ref:P,role:"main",...Q(L),children:[e.jsx(ue,{onClose:()=>{s(0),b()}}),e.jsx("div",{className:`${f}__body`,children:e.jsxs("div",{className:`${f}-element`,children:[!u&&e.jsx(ge,{size:20,className:`${H}__icon-idea`}),u&&(u.render?u.render():e.jsx(ye,{className:`${f}__element-stepped-media`,filePaths:u.filePaths,playStep:0})),e.jsxs("div",{className:`${f}-element__content`,children:[x&&e.jsx("h2",{className:`${f}-element__title`,children:x}),t&&e.jsx("p",{className:`${f}-element__body`,children:t})]}),e.jsx("ul",{className:`${H}__nav-links`,children:N.map((c,r)=>r===$?l(r,c,w):l(r,c))}),O&&e.jsx("div",{className:`${f}__footer`,children:e.jsx(F,{size:"sm",onClick:()=>{s(0),b()},children:O})})]})})]}),j);function l(c,r,T=null){return e.jsx("li",{children:e.jsx(F,{kind:"ghost",size:"sm",onClick:()=>{s(c),_(c+1)},ref:T,children:r})},c)}});C=h.checkComponentEnabled(C,L);C.displayName=L;C.propTypes={className:n.string,closeButtonLabel:n.string,description:n.node.isRequired,isOpen:n.bool.isRequired,media:n.oneOfType([n.shape({render:n.func}),n.shape({filePaths:n.arrayOf(n.string)})]),navLinkLabels:n.arrayOf(n.string).isRequired,onClickNavItem:n.func.isRequired,onClose:n.func.isRequired,portalTarget:n.string,title:n.string.isRequired};C.__docgenInfo={description:`DO NOT USE. This component is for the exclusive use
of other Novice to Pro components.`,methods:[],displayName:"CoachmarkStackHome",props:{className:{description:"Optional class name for this component.",type:{name:"string"},required:!1},closeButtonLabel:{description:"The label for the button that will close the stack",type:{name:"string"},required:!1},description:{description:"The description of the Coachmark.",type:{name:"node"},required:!0},isOpen:{description:"If the stack home is open.",type:{name:"bool"},required:!0},media:{description:`The object describing an image in one of two shapes.
...
element is hidden or component is unmounted, the CoachmarkStackHome will disappear.`,type:{name:"string"},required:!1},title:{description:"The title of the Coachmark.",type:{name:"string"},required:!0}}};const xe=`${h.prefix}--coachmark-stack`,M="CoachmarkStack",d=`${h.prefix}--coachmark-stack-element`,D={onClose:()=>{},theme:"light"};let y=me.forwardRef(({children:o,className:t,onClose:g=D.onClose,description:u,media:N,navLinkLabels:_,portalTarget:b=D.portalTarget,closeButtonLabel:E,tagline:O,theme:x=D.theme,title:B,...P},w)=>{const $=b?document.querySelector(b)??document.querySelector("body"):document.querySelector("body"),s=a.useRef(),j=a.useRef([]),[l,c]=a.useState(!1),[r,T]=a.useState(0),[I,Z]=a.useState(null),ee=a.Children.toArray(o),S=a.useRef(),te=240,ne=i=>{T(i)},v=a.useCallback(i=>{if(i){T(-1);const p=setTimeout(()=>{c(!1),g()},te);return()=>clearTimeout(p)}else T(0)},[g]),R=a.useCallback(i=>{i.key==="Escape"&&v(r===0)},[v,r]);a.useEffect(()=>(document.addEventListener("keydown",R,!1),()=>{document.removeEventListener("keydown",R,!1)}),[R]);const ae={buttonProps:{tabIndex:0,"aria-expanded":l,onClick:()=>{c(!0)},onDoubleClick:()=>{c(!0)}},closeButtonProps:{onClick:()=>v(!1)},isOpen:l};a.useEffect(()=>(S.current=!0,()=>{S.current=!1}),[]),a.useEffect(()=>{setTimeout(()=>{s.current&&Z(s.current.clientHeight+16)},0)},[s]),a.useEffect(()=>{const i=r-1;if(!I)return;if(s.current.style.height=`${I}px`,!l||i<0){s.current.focus();return}const p=j.current[i].clientHeight;s.current.style.height=`${p}px`,j.current[i].focus()},[r,l,I]);const re=a.Children.map(ee,(i,p)=>{const oe=S.current?`${d}--is-mounted`:"";return e.jsx(pe,{ref:se=>j.current[p]=se,kind:fe.STACKED,onClose:()=>v(!1),theme:x,fixedIsVisible:!1,className:q(d,oe,p===r-1&&`${d}--is-visible`,S.current&&`${d}--is-mounted`),children:i},p)});return e.jsx(ke.Provider,{value:ae,children:e.jsxs("div",{...P,className:q(xe,`${h.prefix}--coachmark-overlay--stack`,t),ref:w,...Q(M),children:[e.jsx(be,{title:O,onClose:g}),e.jsx(C,{ref:s,className:q(`${h.prefix}--coachmark-overlay`,`${h.prefix}--coachmark-overlay__${x}`,d,r>0&&`${d}--is-stacked`,r>0&&`${d}--is-stacked__${x}`,l&&`${d}--is-visible`,S.current&&`${d}--is-mounted`),isOpen:l&&r<1,description:u,media:N,navLinkLabels:_,onClickNavItem:ne,onClose:()=>{v(!0)},portalTarget:b,closeButtonLabel:E,title:B}),J.createPortal(re,$)]})})});y=h.checkComponentEnabled(y,M);y.displayName=M;y.propTypes={children:n.node.isRequired,className:n.string,closeButtonLabel:n.string,description:n.node.isRequired,media:n.oneOfType([n.shape({render:n.func}),n.shape({filePaths:n.arrayOf(n.string)})]),navLinkLabels:n.arrayOf(n.string).isRequired,onClose:n.func,portalTarget:n.string,tagline:n.string.isRequired,theme:n.oneOf(["light","dark"]),title:n.string.isRequired};y.__docgenInfo={description:`Stacked coachmarks are used to call out specific functionality or concepts
...
`,e.jsxs(t.p,{children:[e.jsx(t.a,{href:"https://pages.github.ibm.com/security/security-design/department/end-to-end-experiences/novice-to-pro/overview",rel:"nofollow",children:"Novice to pro"}),`
...
NB no need for a 'Playground' because all stories have all controls anyway.`,...(Y=(X=k.parameters)==null?void 0:X.docs)==null?void 0:Y.description}}};const st=["coachmarkStack"];export{st as __namedExportsOrder,k as coachmarkStack,ot as default};
