import{j as l,p,B as i}from"./settings-K-okNOOf.js";import{R as d}from"./index-CTjT7uj6.js";import{P as e}from"./index-BRV0Se7Z.js";import{g as h}from"./devtools-Bwmhsu0A.js";import{a as c}from"./props-helper-BHboZCEP.js";import"./deprecate-BLSDO8J_.js";import{T as u,t as f,p as m}from"./TearsheetShell-b54oqIwy.js";import{A as y}from"./ActionSet-B0KKiE1i.js";const a="Tearsheet";let t=d.forwardRef(({influencerPosition:n="left",influencerWidth:o="narrow",...r},s)=>l.jsx(u,{...h(a),...r,influencerPosition:n,influencerWidth:o,ref:s,size:"wide"}));t=p.checkComponentEnabled(t,a);t.displayName=a;const g={verticalPosition:e.oneOf(["normal","lower"])};t.propTypes={actions:c([y.validateActions(()=>"2xl"),e.arrayOf(e.shape({...i.propTypes,kind:e.oneOf(["ghost","danger--ghost","secondary","danger","primary"]),label:e.string,loading:e.bool,onClick:i.propTypes.onClick}))]),ariaLabel:e.string,className:e.string,closeIconDescription:e.string.isRequired.if(({actions:n,hasCloseIcon:o})=>f(n,o)),description:e.node,hasCloseIcon:e.bool,influencer:e.element,influencerPosition:e.oneOf(["left","right"]),influencerWidth:e.oneOf(["narrow","wide"]),label:e.node,launcherButtonRef:e.any,navigation:e.element,onClose:e.func,open:e.bool,portalTarget:m,selectorPrimaryFocus:e.string,title:e.node,...g};t.__docgenInfo={description:`A tearsheet is a mostly full-screen type of dialog that keeps users
...
? PropTypes.object
: PropTypes.instanceOf(Element)`}},selectorPrimaryFocus:{required:!1,tsType:{name:"string"},description:"Specify a CSS selector that matches the DOM element that should be focused when the Modal opens",type:{name:"string"}},title:{required:!1,tsType:{name:"ReactNode"},description:"The main title of the tearsheet, displayed in the header area.",type:{name:"node"}},verticalPosition:{required:!1,tsType:{name:"union",raw:"'normal' | 'lower'",elements:[{name:"literal",value:"'normal'"},{name:"literal",value:"'lower'"}]},description:`The position of the top of tearsheet in the viewport. The 'normal'
