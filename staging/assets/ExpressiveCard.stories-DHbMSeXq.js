import{j as n,p as se}from"./settings-K-okNOOf.js";import{u as ne,c as ie,_ as ce,k as le}from"./deprecate-BLSDO8J_.js";import{P as e}from"./index-BRV0Se7Z.js";import{R as me,r as de}from"./index-CTjT7uj6.js";import{G as oe}from"./Grid-pQj43W1P.js";import{C as re}from"./Column-YOkLAWmq.js";import{S as ue,a as pe}from"./index-CoeQ0pfL.js";import{a as j}from"./chunk-MZXVCX43-CM0pFb8Z.js";import{g as ge}from"./devtools-Bwmhsu0A.js";import{p as ye}from"./props-helper-BHboZCEP.js";import{C as fe}from"./Card-C2xRo9t_.js";import{b as he,A as Se}from"./bucket-0-oY2tyfOj.js";import"./index-BU4hwJwl.js";import"./events-D0gen66i.js";import"./index-DN5spsdJ.js";import"./index-DASh2Ycj.js";import"./bucket-16-C5jbOqAN.js";import"./v4-CQkTLCs1.js";import"./index-BPxLliBq.js";import"./Text-CJa2B8Yb.js";import"./useAttachedMenu-TY58osux.js";import"./bucket-11-DVAi0r8D.js";import"./wrapFocus-ldDxJswA.js";import"./mergeRefs-CTUecegF.js";import"./createClassWrapper-CcV1pVUD.js";import"./index-JTvCgqhd.js";import"./LayerContext-BJwyboGm.js";import"./bucket-5--iEWWNCt.js";import"./bucket-8-zc1UuW7K.js";const te=o=>{let{as:t="div",className:i,children:m,ratio:d="1x1",...c}=o;const l=ne(),C=ie(i,`${l}--aspect-ratio`,`${l}--aspect-ratio--${d}`);return me.createElement(t,ce({className:C},c),m)};te.propTypes={as:e.elementType,children:e.node,className:e.string,ratio:e.oneOf(["16x9","9x16","2x1","1x2","4x3","3x4","3x2","2x3","1x1"])};const z="ExpressiveCard";let s=de.forwardRef((o,t)=>{const i=ye(o,["actionIconsPosition","overflowActions","productive","titleSize"]);return n.jsx(fe,{ref:t,...i,...ge(z)})});s=se.checkComponentEnabled(s,z);s.propTypes={actionIcons:e.arrayOf(e.shape({id:e.string,icon:e.oneOfType([e.func,e.object]),onKeyDown:e.func,onClick:e.func,iconDescription:e.string,href:e.string})),children:e.node,className:e.string,description:e.oneOfType([e.string,e.object,e.node]),label:e.oneOfType([e.string,e.object,e.node]),media:e.node,mediaPosition:e.oneOf(["top","left"]),onClick:e.func,onPrimaryButtonClick:e.func,onSecondaryButtonClick:e.func,pictogram:e.oneOfType([e.func,e.object]),primaryButtonHref:e.string,primaryButtonIcon:e.oneOfType([e.func,e.object]),primaryButtonKind:e.oneOf(["primary","ghost"]),primaryButtonText:e.string,secondaryButtonHref:e.string,secondaryButtonIcon:e.oneOfType([e.func,e.object]),secondaryButtonKind:e.oneOf(["secondary","ghost"]),secondaryButtonText:e.string,slug:e.oneOfType([e.node,e.bool]),title:e.oneOfType([e.string,e.object,e.node])};s.displayName=z;s.__docgenInfo={description:"",methods:[],displayName:"ExpressiveCard",props:{actionIcons:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id?: string;
  icon?: () => void | object;
  onKeydown?: () => void;
  onClick?: () => void;
...
}`,...(ee=(Z=b.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};const Xe=["Default","LabelOnly","WithCaption","WithMedia","WithActionIconHref","WithPictogram","WithSecondaryAction","Clickable","WithButtonHref","WithButtonIcon"];export{x as Clickable,u as Default,p as LabelOnly,f as WithActionIconHref,v as WithButtonHref,b as WithButtonIcon,g as WithCaption,y as WithMedia,h as WithPictogram,S as WithSecondaryAction,Xe as __namedExportsOrder,Ve as default};
